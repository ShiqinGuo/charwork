...
DEFAULT_EXTERNAL_SERVICE_URLS = {
    ...
    "RABBITMQ_URL": "amqp://admin:admin123@115.190.28.100:5672/",
}
...
DEFAULT_URL_REFRESH_CONFIG = {
    "URL_REFRESH_ENABLED": False,
    "URL_REFRESH_INTERVAL_MINUTES": 5,
    "URL_REFRESH_BATCH_SIZE": 5000,
    "URL_REFRESH_DOMAINS": "veimagex",
}
...
class Settings(BaseSettings):
    ...
    RABBITMQ_URL: str = DEFAULT_EXTERNAL_SERVICE_URLS["RABBITMQ_URL"]
    # 中间件业务配置
    CELERY_BROKER_URL: str = DEFAULT_EXTERNAL_SERVICE_URLS["RABBITMQ_URL"]
    ELASTICSEARCH_INDEX_PREFIX: str = DEFAULT_SEARCH_SYNC_CONFIG["ELASTICSEARCH_INDEX_PREFIX"]
    ELASTICSEARCH_REQUEST_TIMEOUT: int = DEFAULT_SEARCH_SYNC_CONFIG["ELASTICSEARCH_REQUEST_TIMEOUT"]
    SEARCH_SYNC_ENABLED: bool = DEFAULT_SEARCH_SYNC_CONFIG["SEARCH_SYNC_ENABLED"]
    SEARCH_SYNC_RABBITMQ_URL: str = DEFAULT_EXTERNAL_SERVICE_URLS["RABBITMQ_URL"]
    ...
    IMAGEX_EXPIRE: int = DEFAULT_VOLCENGINE_CONFIG["IMAGEX_EXPIRE"]    # 已废弃，实际 TTL 由 ocr_service 传给 SDK
    IMAGEX_TEMPLATE_ID: str = DEFAULT_VOLCENGINE_CONFIG["IMAGEX_TEMPLATE_ID"]

    # ImageX URL 定时刷新
    URL_REFRESH_ENABLED: bool = DEFAULT_URL_REFRESH_CONFIG["URL_REFRESH_ENABLED"]
    URL_REFRESH_INTERVAL_MINUTES: int = DEFAULT_URL_REFRESH_CONFIG["URL_REFRESH_INTERVAL_MINUTES"]
    URL_REFRESH_BATCH_SIZE: int = DEFAULT_URL_REFRESH_CONFIG["URL_REFRESH_BATCH_SIZE"]
    URL_REFRESH_DOMAINS: str = DEFAULT_URL_REFRESH_CONFIG["URL_REFRESH_DOMAINS"]
