...
from app.api.v1 import (
    ...
    routes_assignment_templates,
    routes_assignments,
    routes_auth,
    routes_comments,
    routes_courses,
    routes_custom_fields,
    routes_dataset_import,
    routes_export,
    routes_hanzi,
    routes_import,
    routes_logs,
...
ROUTER_CONFIGS = (
    ...
    (routes_assignment_templates.router, f"{settings.API_V1_STR}/assignment-templates", ["assignment-templates"]),
    ...
    (routes_dataset_import.router, f"{settings.API_V1_STR}/dataset-import", ["dataset-import"]),
