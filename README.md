...
- 课程与班级：课程管理、教学班级、师生关联、学生班级关系
- 学生作业提交与批改：提交状态机、AI 智能批改反馈、AI 总结
- AI 批改反馈：对书写附件进行 AI 评价，支持运行时编排与异步生成
- 评论与点赞、站内消息
- AI 对话：集成火山方舟 / OpenAI 兼容接口，支持上下文记忆与工具调用
- 全文检索：基于 Elasticsearch，支持跨实体搜索、Canal CDC 实时同步
